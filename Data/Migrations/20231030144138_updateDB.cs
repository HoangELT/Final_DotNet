        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreate = table.Column<DateTime>(type: "datetime2", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmallDescription = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false),
                    DisPrice = table.Column<double>(type: "float", nullable: false),
                    CurPrice = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmallContent = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
